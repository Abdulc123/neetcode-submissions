public class Solution {
    public List<List<string>> GroupAnagrams(string[] strs) {
        ...
        // .Values gets the values from the results dictionary, stores the dictionary values as IEnumerable<List<string>>.
        // .ToList() takes the contents of IEnumerable<T> and stores them in a new List<T>.
    }
}
